                ...
                <div class="col-md-12">
                    <blockquote>
                        ...
                        <p style="font-size:16px">
                            ...
                            <a href="https://help.delivrd.com/delivrd/sales-order-management/managing-sales-orders-in-delivrd" target="_blank" class="btn blue-hoki fileinput-button"><i class="fa fa-question-circle"></i> Tutorial</a>
                        </p>
                    </blockquote>
                    <br>
                    <?php echo $this->Form->create('Order', array(
                                        'url' => array('controller' => 'orders', 'action' => 'uploadcsv'),
                                        'id' => 'fileupload',
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <ul>
                                ...
                                <li>
                                     To review all imported orders, click here
                                </li>
                            </ul>
                                </div>
                    </div>*/ ?>
...
<script id="template-download" type="text/x-tmpl">
    {% for (var i=0, file; file=o.files[i]; i++) { %}
        <tr class="template-download fade">
            ...
            <td>
                <a href="<?php echo $this->Html->url('importcsv', true); ?>/{%=file.name%}" class="btn blue"><i class="fa fa-shopping-cart"></i>Create Orders</a> 
            </td>
        </tr>
    {% } %}
</script>