<?php echo $this->Form->create('Address', array('url' => array('controller' => 'orders', 'action' => 'saveAddress'), 'class' => 'form-horizontal', 'id' => 'add-edit-form')); ?>
  ...
  <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary saveBtn" id="submit">Save Address</button>
  </div> 
