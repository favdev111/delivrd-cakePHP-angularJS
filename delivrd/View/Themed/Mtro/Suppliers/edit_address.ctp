<?php echo $this->Form->create('Supplier', array('url' => array('controller' => 'suppliers', 'action' => 'saveAddress'), 'class' => 'form-horizontal', 'id' => 'add-edit-form')); ?>
	 <div class="modal-body">
                <div id="response-bin"></div>
                <div class="form-group">
	                <div class="col-md-3">
	                <?php echo $this->Form->hidden('Supplier.id',array('id' => 'location-id','hidden' => true)); ?>
  ...
  <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary saveBtn" id="submit">Save Supplier Address</button>
  </div> 
