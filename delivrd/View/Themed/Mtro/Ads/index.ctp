				...
				<div class="col-md-12">
					...
					<div class="portlet box delivrd">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-truck"></i>Ads
							</div>
							<div class="actions">
								
							<a href="/ads/add" class="btn default ">
    ...
    'url' => array_merge(
            ...
            $this->params['pass']
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right">
										<li>
										<a href="/ads/edit/<?php echo $ad['Ad']['id'] ?>">
										<i class="fa fa-edit"></i>
										Edit
										</a>	
										</li>
										<li><?php echo $this->Form->postLink(__('<i class="fa fa-trash-o"></i> Delete'), array('action' => 'delete', $ad['Ad']['id']), array('escape'=> false), __('Are you sure you want to delete courier %s?', $ad['Ad']['name'])); ?></li>
