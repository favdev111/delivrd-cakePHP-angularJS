											...
											<div class="row static-info">
															...
															<div class="col-md-7 value">
																...
																* </span>
                                                                                                                         ...
                                                                                                                         <div class="col-md-7 value">
																 <?php echo $this->Form->input('position',array('label' => false,'class' => 'form-control','div' =>false, 'options' => array('Header' => 'Header','Footer' => 'Footer','SideBar' => 'SideBar','InResults' => 'InResults'),'empty' => '(choose one)')); ?>
															</div>
                                                                                                                         </div>
