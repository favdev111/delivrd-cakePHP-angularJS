				...
				<div class="col-md-12">
					...
					<div class="portlet box delivrd">
						<div class="portlet-title">
							...
							<div class="actions">
							<?php echo $this->Html->link(__('<i class="fa fa-plus"></i><span class="hidden-480">
								New Category </span>'), array('controller'=> 'categories','action' => 'add'),array('escape'=> false, 'class' => 'btn default yellow-stripe')); ?>	
							<div class="btn-group">
							...
							<div class="table-container">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right">
										...
										Edit'), array('controller'=> 'categories','action' => 'edit',$category['Category']['id']),array('escape'=> false)); ?>
										</li>
										<li><?php echo $this->Form->postLink(__('<i class="fa fa-trash-o"></i> Delete'), array('action' => 'delete', $category['Category']['id']), array('escape'=> false), __('Are you sure you want to delete the category %s?', h($category['Category']['name']))); ?></li>
