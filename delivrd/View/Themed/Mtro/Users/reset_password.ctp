...
<div class="content">
	...
	echo $this->Form->create($model, array(
		...
		'label' => __d('users', 'New Password'),'placeholder'=>'Enter new password', 'class' => 'form-control form-control-solid placeholder-no-fix',
		'type' => 'password','label' => false));
			echo '</div>';
			echo '<div class="form-group">';
			echo '<label class="control-label visible-ie8 visible-ie9">Password, Again</label>';
			echo $this->Form->input('confirm_password', array(
		'label' => __d('users', 'Confirm'),'placeholder'=>'Re-enter the password', 'class' => 'form-control form-control-solid placeholder-no-fix',
		'type' => 'password', 'label' => false));
			echo '</div>';
			?>
