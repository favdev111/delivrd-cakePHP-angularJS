...
<div class="content">
	...
	<h3 class="form-title">Request New Password</h3>
	...
	echo $this->Form->create($model, array(
		...
		'label' => __d('users', 'New Password'),'placeholder'=>'Enter your email address', 'class' => 'form-control form-control-solid placeholder-no-fix',
		 'label' => false));
			echo '</div>';
