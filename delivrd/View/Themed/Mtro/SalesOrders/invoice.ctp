    ...
    <div class="page-content">
        ...
        <div class="invoice">
            <div class="row invoice-logo" >
                <div class="col-xs-12">
                    <h3 class="text-center" style="margin-bottom:0;"><?php echo __('Invoice #') . $order['Order']['id']; ?></h3>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <?php /*<th class="hidden-480 quantity displayAdd hide">BIN</th>
                        ...
                        <?php $qtySum = 0; foreach ($order['OrdersLine'] as $ordersLine) { ?>
                            <tr>
                                ...
                                <?php /*<td class="hidden-480 displayAdd hide">
