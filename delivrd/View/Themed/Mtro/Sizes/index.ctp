				...
				<div class="col-md-12">
					...
					<div class="portlet box delivrd">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-rss"></i>Sizes
							</div>
							<div class="actions">
							<?php echo $this->Html->link(__('<i class="fa fa-plus"></i><span class="hidden-480">
								New Size </span>'), array('controller'=> 'sizes','action' => 'add'),array('escape'=> false, 'class' => 'btn default yellow-stripe')); ?>		
							<div class="btn-group">
							...
							<div class="table-container">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right">
										...
										Edit'), array('controller' => 'sizes', 'action' => 'edit', $size['Size']['id']), array('escape' => false)); ?>
										</li>
										<li><?php echo $this->Form->postLink(__('<i class="fa fa-trash-o"></i> Delete'), array('action' => 'delete', $size['Size']['id']), array('escape'=> false), __('Are you sure you want to delete the size %s?', h($size['Size']['name']))); ?></li>
