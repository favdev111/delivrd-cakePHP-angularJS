                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value">
                                            <?php echo $this->Form->input('user_id',array('id' => 'user_id', 'div'=>'false', 'label' => false, 'class' => 'form-control select2me', 'placeholder' => 'Select...', 'empty' => 'Select...', 'required' )); ?>
                                        </div>
                                    </div>
...
<?php $this->Html->scriptStart(array('inline' => true, 'block'=>'jsAction')); ?>
    $('select#user_id').on('select2-selecting', function (e) {
        $.ajax({
