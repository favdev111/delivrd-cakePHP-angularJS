            ...
            <div class="col-md-12">
                <blockquote>
                    <p style="font-size:16px">
                        Update your Forecast by a csv file
                    </p>
                    <p style="font-size:16px">
                        <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i> Download Sample File','/products/forecastcsv',array('class' => 'btn blue-hoki fileinput-button','escape'=> false)); ?>
                    </p>
                </blockquote>
                <br>
...
<script id="template-download" type="text/x-tmpl">
    {% for (var i=0, file; file=o.files[i]; i++) { %}
        <tr class="template-download fade">
            ...
            <td>
                <a href="<?php echo $this->Html->url('import_fc_csv', true); ?>/{%=file.name%}/{%=file.uname%}" data-toggle="modal" data-target="#ajaxModal" rel="modal-lg" class="btn blue"><i class="fa fa-barcode"></i>Import Forecast Records</a>
            </td>
