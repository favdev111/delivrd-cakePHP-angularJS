<!-- BEGIN CONTENT -->
<div class="page-content-wrapper" ng-controller="EditField">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div ng-repeat="option in field_options" class="clearfix" style="margin-bottom: 5px;">
                                            <div class="col-md-8">
                                                <input type="hidden" name="data[FieldsValue][{{option.FieldsValue.id}}][id]" class="form-control"  value="{{option.FieldsValue.id}}"/> 
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-md-8"><?php echo $this->Form->input('Field.is_filter', array('class' => 'form-control', 'type' => 'checkbox', 'div' => false, 'label' => false )); ?> Filter by custom field</label>
                                </div>
...
<?php echo $this->Html->script('/app/Fields/edit.js', array('block' => 'pageBlock')); ?>

<script>
<?php $this->Html->scriptStart(array('inline' => true, 'block'=>'jsAction')); ?>
    var field = <?php echo json_encode($field); ?>;
    var field_options = <?php echo json_encode($field_options); ?>;
