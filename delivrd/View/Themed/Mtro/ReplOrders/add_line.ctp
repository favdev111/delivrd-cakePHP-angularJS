<div class="modal-dialog modal-lg">
    <div class="modal-content">
                ...
                <tbody>
                    <tr>
                        <td style="position: relative;">
                            ...
                            <input type="text" id="product_id" name="data[OrdersLine][product_id]" class="form-control input-medium" placeholder="Select..." required>
                        </td>
                        ...
                        <td>
                            <div class="input-group date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                <input type="text" class="form-control form-filter" id="OrderScheduleDeliveryDate" name="data[OrderSchedule][delivery_date]" value="" >
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            </div>
                        </td>
                        <td ng-if="is_blanket == 0">
        ...
        <div class="modal-footer">
            <button class="btn green-jungle" ng-click="addProductContinue($event)" <?php echo (!$products ? 'disabled':'')?>  ng-if="is_blanket == 0"><i class="fa fa-plus"></i> Save &amp; Add Another</button>
...
<script>
    $(document).ready(function(){
        ...
        $('#product_id').select2({
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo $this->Html->url(array('controller'=>'products', 'action' => 'getPurchasePrice')); ?>/'+e.val+'/<?php echo $order['Order']['supplier_id']; ?>',
                data: '',
                dataType:'json',
