                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        ...
                        <?php if($this->Session->read('is_admin') == 3 || $this->Session->read('is_admin') == 1) { ?>
                            <li ng-if="(order.Order.status_id == 2 || order.Order.status_id == 3) && is_write && is_shipment"><?php echo $this->Html->link(__('<i class="fa fa-truck"></i> Create Shipment'), array('controller' => 'shipments', 'action' => 'add',$order['Order']['id']), array('escape'=> false)); ?></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-random"></i>Order #<?php echo h($order['Order']['id']) ?> <span class="hidden-480">
                            | Created <?php echo $this->Admin->localTime("%B %e, %Y, %l:%M %p", strtotime($order['Order']['created']));?></span>
                        </div>
                        <div class="actions">
                            ...
                            <div class="btn-group pull-right" style="margin-left: 10px;">
                                <?php echo $this->Html->link(__('<i class="fa fa-unlock"></i> Release'), array('action' => 'release',$order['Order']['id'], '?' => ['f' => 'd']), array('escape'=> false, 'class' => 'btn btn-fit-height blue', 'ng-if' => 'is_write && order.Order.status_id == 14', 'style' => 'margin-right: 13px;')); ?>
                                <?php #echo $this->Html->link(__('<i class="fa fa-credit-card"></i> Paid'), array('action' => 'paid', $order['Order']['id'], '?' => ['f' => 'd']), array('escape'=> false, 'class' => 'btn btn-fit-height green-jungle', 'ng-click' =>'makePaid('. $order['Order']['id'] .')', 'ng-if' => 'is_write && order.Order.status_id == 4', 'style' => 'margin-right: 13px;')); ?>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="row static-info">
                                                        ...
                                                        <div class="col-md-7 value">
                                                            ...
                                                            {{ moment().tz(order.Order.requested_delivery_date, "America/Los_Angeles").format() }}
                                                        </div>
                                                    </div>
                                                    <div class="row static-info">
                                                        <div class="col-md-5 name">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="portlet grey-cascade box">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions" ng-if="is_write && order.Order.status_id == 14 || order.Order.status_id == '2' || order.Order.status_id == '3'">
                                                            <button class="btn btn-primary" ng-click="addLine()" style="margin-left:8px;"><i class="fa fa-plus"></i> Add Order Lines</button>
                                                        </div>
                                                        <div class="actions" ng-if="is_write && (order.Order.status_id == 2 || order.Order.status_id == 3 || order.Order.status_id == 8)">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <tbody>
                                                                <tr ng-repeat="line in lines | orderBy:sortType:sortReverse" id="line_{{line.OrdersLine.id}}">
                                                                    ...
                                                                    <td>{{line.OrderSchedule.delivery_date}}</td>
                                                                    <td ng-if="order.Order.status_id != 4 && is_write">
                                                                        <div ng-if="is_writeable(line.Warehouse.id)">
                                                                            <button ng-if="line.OrdersLine.type != 4 && (order.Order.status_id == '14' || order.Order.status_id == '2' || order.Order.status_id == '3')" 
                                                                                class="btn btn-sm default btn-editable"
                                                                                ng-click="openEditRow(line.OrdersLine.id)">
                                                                                <i class="fa fa-edit"></i> Edit
                                                                            </button>
                                                                            <button ng-if="line.OrdersLine.status_id != 8 && line.OrdersLine.status_id != 4 && (order.Order.status_id == '14' || line.OrdersLine.receivedqty == 0)" 
                                                                                class="btn btn-sm default btn-editable"
                                                                            ...
                                                                            <button ng-if="order.Order.status_id == '2' || order.Order.status_id == '3'"
                                                                                ...
                                                                                <span class="badge">{{line.OrdersLine.receivedqty}}</span> <i class="fa fa-arrow-left"></i> Receive Order Products
                                                                            </button>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <table class="table table-hover dataTable no-footer" id="datatable_history" role="grid">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="<?php echo ($key % 2 == 0 ? "odd" : "even"); ?>">
                                                        ...
                                                        <td><?php echo "Order status changed to ". h($objectevent['Status']['name']); ?></td>
                                                        <td></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
...
<?php $this->Html->scriptStart(array('inline' => true, 'block'=>'jsAction')); ?>
    ...
    var is_shipment = <?php echo $is_shipment; ?>;
...
<?php echo $this->Html->script('/app/ReplOrders/details.js?v=0.0.92', array('block' => 'pageBlock')); ?>
<?php echo $this->Html->script('/app/Documents/view.js?v=0.0.2', array('block' => 'pageBlock')); ?>
<?php echo $this->Html->script('/assets/global/plugins/moment.min.js', array('block' => 'pageBlock')); ?>
<?php echo $this->Html->script('/assets/global/plugins/moment-timezone.min.js', array('block' => 'pageBlock')); ?>