        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="form-group">
                        <label>Country:</label>
                        <?php echo $this->Form->input('Address.country_id',array('id' => 'country_id', 'label' => false, 'class' => 'form-control select2me', 'placeholder' => '')); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function showProvince() {
        if($('#OrderCountryId').val() == '227') {
            $('#OrderStateId').parent('.form-group').show();
        } else {
            $('#OrderStateId').parent('.form-group').hide();
        }
    }
</script>
<style>
