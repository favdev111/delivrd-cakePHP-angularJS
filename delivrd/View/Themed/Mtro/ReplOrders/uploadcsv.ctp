        ...
        <div class="row">
            <div class="col-md-12">
                <blockquote>
                    ...
                    <p style="font-size:16px">
                        <?php echo $this->Html->link(__('<i class="fa fa-cloud-download"></i> Download Sample File'), array('controller' => 'replorders','action' => 'downloadsamplefile'),array('class' => 'btn blue-hoki fileinput-button', 'escape'=> false)); ?>
                        <a href="https://delivrd.freshdesk.com/support/solutions/articles/17000013488-managing-purchase-orders-in-delivrd" target="_blank" class="btn blue-hoki fileinput-button"><i class="fa fa-question-circle"></i> Tutorial</a>
                    </p>
                </blockquote>
                <br>
                <?php echo $this->Form->create('Order', array(
                                    'url' => array('controller' => 'replorders', 'action' => 'uploadcsv'),
                                    'id' => 'fileupload',
