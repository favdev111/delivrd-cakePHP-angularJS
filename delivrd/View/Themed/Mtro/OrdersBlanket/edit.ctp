    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                ...
                Edit Order Blanket Line <i class="fa fa-angle-right"></i>
                Order #<?php echo $order_line['Order']['external_orderid']; ?>
            </h4>
        </div>
        <?php echo $this->Form->create('OrdersBlanket', ['ng-submit' => 'editProduct($event)', 'role'=>'form']); ?>
