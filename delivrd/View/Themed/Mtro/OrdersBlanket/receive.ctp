    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                ...
                Receive Blanket Order Product <i class="fa fa-angle-right"></i>
                Order #<?php echo $blanketline['Order']['external_orderid']; ?>
            </h4>
        </div>

        <?php echo $this->Form->create('OrdersBlanket', array('class' => 'form-horizontal form-row-seperated', 'ng-submit' => 'receiveProduct($event)', 'novalidate' => true)); ?>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-7 value">
                                        <?php echo $this->Form->input('receivedqty',array( 'disabled' => 'disabled','label' => false, 'class' => 'form-control input-sm' )); ?>
                                    </div>
                                </div>
                                ...
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-7 value">
                                        <?php  echo $this->Form->input('warehouse_id',array( 'label' => false, 'class' => 'form-control input-sm', 'min' => 0, 'required' => 'true', 'disabled' )); ?>
                                    </div>
                                </div>
                                <?php } ?>
                                <div class="row static-info">
                                    <div class="col-md-5 name">
                                        <label class="control-label">Receive Quantity: <span class="required">*</span></label>       
                                    </div>
                                    <div class="col-md-7 value">
                                        <?php  echo $this->Form->input('new_receivedqty',array( 'label' => false, 'class' => 'form-control input-sm', 'type' => 'number', 'min' => 0, 'max' => ($blanketline['OrdersBlanket']['quantity'] - $blanketline['OrdersBlanket']['receivedqty']) , 'required' => 'true')); ?>
                                    </div>
                                </div>
                                ...
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-7 value">
                                        <?php  echo $this->Form->input('comments',array( 'label' => false, 'value' => '', 'class' => 'form-control input-sm')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-footer">
            <button class="btn btn-success" id="receiveLineBtn"><i class="fa fa-plus"></i> Receive</button>
...
<script>
    $(document).ready(function(){
        $('#OrdersBlanketWarehouseId').select2({minimumResultsForSearch: -1});
    });
</script>
<style>
