...
app.controller( 'SupplierList', ['$scope', '$http', '$modal', '$sce', function ($scope, $http, $modal, $sce) {

    $scope.addDocument = function(suppl_id, suppl_name) {
        var modalDocumentInstance = $modal.open({
            templateUrl: siteUrl+'documents/view/supplier/'+suppl_id+'?f=l&bust='+Math.random().toString(36).slice(2),
