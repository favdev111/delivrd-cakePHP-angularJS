...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
            <?php echo $this->Form->create('Warehouse', array('class' => 'form-horizontal form-row-seperated'));  ?>            
                                        ...
                                        <div class="row static-info">
                                            ...
                                            <div class="col-md-7 value">
                                                <label class="control-label">
                                                    <?php  echo $this->Form->input('status', array('type' => 'checkbox', 'value' => 'active', 'checked', 'label' => false, 'div' => false)); ?>
                                                    Is Active
                                                </label>
                                            </div>
                                        </div>
