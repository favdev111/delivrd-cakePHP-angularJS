 ...
 */
	protected $nvpUsername = 'd_business_api1.email.com';

/**
 * API credentials - nvp password
 */
	protected $nvpPassword = '1364684510';

/**
 * API credentials - nvp signature
 */
	protected $nvpSignature = 'A9XhqMTD79xSretq1yYaBFemz2elAHZij7JLLXHWlMPlkiLTUVvSP9SD';
 ...
 */
	protected $oAuthClientId = 'AXtXLNECz2iO11CRcfFbbaWpF0zhm6VYKZ4PQvMy5zxsAzvf0rhbDmBtqxBAIG5GdeO4oR-Pr9dxT0vc';

/**
 * API credentials - oAuth secret
 */
	protected $oAuthSecret = 'EK9zTdpkarRq42BVclDAACqButNZ5yUG8F7TDnNEGda03gOs0HKy0-Lig4Fqa32E0vfNAYPSmk2vn_Zr';
