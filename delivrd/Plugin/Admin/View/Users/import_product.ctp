			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-steel">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-upload"></i> Import Products for user <?php echo $user['User']['email'];?>
						</div>
					</div>
					<div class="portlet-body" style="width: 100%;display: inline-block;">
						...
						<?php if(!$matchColumnDisplay){ ?>
							<?php echo $this->Form->create('fileupload', array('class'=>'form-inline', 'url' => 'import_product/'. $user['User']['id'], 'type' => 'file')); ?>
							<div class="row">
								<div class="col-md-6">
						...
						<?php } else { ?>
							...
							<form action="/admin/users/add_product/<?php echo $user['User']['id']; ?>" method="post" id="matchForm" name="matchForm">
...
<div class="modal fade" id="FieldsModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form action="/admin/users/create_new_fields/<?php echo $user['User']['id']; ?>" id="newfieldsform" method="Post" >
...
$('#fileuploadPhoto').siblings('label').css('display','none');
 $(document).on('click','#validate_data',function(){
	...
	var url = '/admin/users/validate_csv/<?php echo $user['User']['id']; ?>';
